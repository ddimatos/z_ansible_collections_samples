...
Check [setting environment variables](https://www.ibm.com/docs/en/cic/1.2.4?topic=descriptions-setting-environment-variables) for more details.
...
8. Verify that all components in the IBM Cloud Infrastructure Center are working as desired.
...
| `os_flavor_storage`       | medium                                          | `openstack flavor list`, Minimum flavor disk size >= 35 GiB                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `os_flavor_infra`         | medium                                          | `openstack flavor list`, Minimum flavor disk size >= 35 GiB                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `os_control_nodes_number` | 3                                               | (Integer) Number of Red Hat Openshift provisioned control server nodes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `os_compute_nodes_number` | 3                                               | (Integer) Number of Red Hat Openshift provisioned worker server nodes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `os_storage_nodes_number` | 0                                               | (Integer) Number of Red Hat Openshift provisioned storage server nodes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `os_infra_nodes_number`   | 0                                               | (Integer) Number of Red Hat Openshift provisioned infra server nodes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `add_secgroups`   | \<add_secgroups\>                                              | List additional security groups here to be added to all nodes (KVM). Example: security_group1,security_group2                                                                                                                                                                                                                  |
| `add_bootstrap_secgroups`   | \<add_bootstrap_secgroups\>                                             | List additional security groups here to be added to bootstrap node (KVM). Example: security_group1,security_group2                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `storage_name_prefix`            | \<storage-node-name\>                            | The name and hostname of the storage nodes, such as `ocp4zkw`. If specific name is not required, leave the default value `` here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `infra_name_prefix`            | \<infra-node-name\>                            | The name and hostname of the infra nodes, such as `ocp4zkw`. If specific name is not required, leave the default value `` here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `os_worker_ip`             | \<infra ip list\>                                       | '[x.x.x.x, x.x.x.x, x.x.x.x], <br>**required** when `auto_allocated_ip` is false                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `os_storage_ip`             | \<infra ip list\>                                       | '[x.x.x.x, x.x.x.x, x.x.x.x], <br>**required** when `auto_allocated_ip` is false                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `additional_certs`        | `{{ lookup('file', '/opt/registry/certs/domain.crt')}}` | The local mirror registry repo additionally need SSL certificated to be accessed, those can be added cert file via the `additional_certs` variable.                                                                                                                                                                                                                                                                                                                                                                                                       |
...
```
Use this playbook to add multiple infra nodes as allocated IP:
```sh
ansible-playbook -i inventory.yaml add-new-compute-node.yaml -e worker_number=3 -e comp_name_suffix=infra
```
...
```
Use this playbook to add multiple storage nodes as fixed IP, separate the IP list with commas:
```sh
ansible-playbook -i inventory.yaml add-new-compute-node.yaml -e ip=x.x.x.x,x.x.x.x -e worker_number=2 -e comp_name_suffix=storage
```
